...
html_context = dict(
    ...
    github_repo="cell-ann",   # Repo name
...
html_title = "cell-ann"
html_logo = "../imgs/cell_ann_logo.png" # torch-adata.logo.small.svg"

html_theme_options = {
    "github_url": "https://github.com/mvinyard/cell-ann",
    "twitter_url": "https://twitter.com/vinyard_m",
    "codetextcolor": "15616d",
}
